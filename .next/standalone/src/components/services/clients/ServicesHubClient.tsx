    ...
    <>
      ...
      <section className={pageSectionClasses(1)}>
        <div className="container-site">
          <motion.div className="service-section-header max-w-6xl" variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }}>
            ...
            <motion.h2 variants={fadeUp} className="type-section mt-4 text-balance leading-[1.1]">
              <TwoLineText text={c.pathways.title} variant="section" />
            </motion.h2>
            <motion.p variants={fadeUp} className="service-section-subtitle">
              <TwoLineText text={c.pathways.subtitle} variant="body" />
            </motion.p>
          </motion.div>
