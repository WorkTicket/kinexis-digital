"use strict";exports.id=4260,exports.ids=[4260],exports.modules={2142:(a,b,c)=>{c.d(b,{C9:()=>o,E6:()=>n,MS:()=>g,PW:()=>f,Sf:()=>e,ad:()=>k,iD:()=>q,lZ:()=>l,n7:()=>i,nA:()=>p,oj:()=>m,rs:()=>j});let d=["seo","local-seo","ppc-management","google-ads","meta-ads","web-design","cro","email-marketing","content-marketing","social-media","video-marketing","branding","analytics","growth-consulting","funnels","paid-ads"],e={seo:"/services/seo","local-seo":"/services/local-seo","ppc-management":"/services/ppc-management","google-ads":"/services/google-ads","meta-ads":"/services/meta-ads","web-design":"/services/web-design",cro:"/services/funnels","email-marketing":"/services/email-marketing","content-marketing":"/services/content-marketing","social-media":"/services/social-media","video-marketing":"/services/video-marketing",branding:"/services/branding",analytics:"/services/analytics","growth-consulting":"/services/growth-consulting",funnels:"/services/funnels","paid-ads":"/services/paid-ads"},f={seo:"SEO Services","local-seo":"Local SEO Services","ppc-management":"PPC Management","google-ads":"Google Ads Management","meta-ads":"Meta Ads Management","web-design":"Web Design Services",cro:"Conversion Rate Optimization","email-marketing":"Email Marketing Services","content-marketing":"Content Marketing Services","social-media":"Social Media Marketing Services","video-marketing":"Video Marketing Services",branding:"Branding Services",analytics:"Marketing Analytics Services","growth-consulting":"Growth Consulting Services",funnels:"Funnels & Conversion Rate Optimization","paid-ads":"Paid Ads"},g=["/","/about","/contact","/lead-magnet","/services","/blog","/blog/posts","/case-studies","/digital-marketing-agency","/industries","/solutions","/resources","/privacy","/terms"],h=["cro"],i=d.filter(a=>!h.includes(a)),j=d,k=j.filter(a=>!h.includes(a)),l=Object.fromEntries(d.map(a=>[a,`/pricing/${a}`])),m=["google-ads-vs-seo","seo-vs-ppc","wordpress-vs-webflow","local-seo-vs-google-ads"],n={"google-ads-vs-seo":"/google-ads-vs-seo","seo-vs-ppc":"/seo-vs-ppc","wordpress-vs-webflow":"/wordpress-vs-webflow","local-seo-vs-google-ads":"/local-seo-vs-google-ads"},o=["sarah-mitchell","james-chen","maria-rodriguez"],p=["local-seo-strategy-2026","email-nurture-sequences-that-book-calls","website-conversion-optimization","google-business-profile-tips","seo-vs-google-ads","technical-seo-fundamentals","local-business-growth-playbook","technical-seo-guide","internal-linking-guide","seo-audit-framework","link-building-strategies","local-seo-checklist","quality-score-guide","negative-keywords-guide","landing-page-best-practices","roas-calculations","heatmap-analysis","conversion-psychology","ab-testing-framework","landing-page-optimization","lifecycle-marketing","automated-nurture-sequences","email-segmentation","attribution-models","ga4-reporting","marketing-dashboards"],q=["landscaping-company-growth","plumbing-company-growth","saas-platform-growth"]},23352:(a,b,c)=>{c.d(b,{Lr:()=>j});let d={seo:`<p><a href="/services/seo">Explore our SEO services →</a></p>`,localSeo:`<p><a href="/services/local-seo">Explore our Local SEO services →</a></p>`,googleAds:`<p><a href="/services/google-ads">Explore our Google Ads Management services →</a></p>`,ppc:`<p><a href="/services/ppc-management">Explore our PPC Management services →</a></p>`,funnels:`<p><a href="/services/funnels">Explore our Funnels & CRO services →</a></p>`,analytics:`<p><a href="/services/analytics">Explore our Marketing Analytics services →</a></p>`,email:`<p><a href="/services/email-marketing">Explore our Email Marketing services →</a></p>`},e={"technical-seo-guide":`<p>Google cannot rank what it cannot crawl, render, and index cleanly. Technical SEO is the infrastructure layer that makes every content investment and link acquisition effort actually count. At KINEXIS Digital, we start most engagements with a technical baseline because fixing indexation and speed problems often produces ranking movement before a single new blog post goes live.</p>
...
${d.googleAds}`,"negative-keywords-guide":`<p>Negative keywords are the fastest lever in PPC to stop wasted spend. Every dollar on irrelevant searches is a dollar not scaling winners. Yet most accounts treat negatives as reactive cleanup instead of a proactive system. Weekly search term reviews should be non-negotiable, backed by shared lists and clear ownership.</p>
...
${d.analytics}`,"heatmap-analysis":`<p>Heatmaps show where users click, how far they scroll, and what they ignore. That beats debating redesigns from opinions alone. Session recordings plus heatmap data reveal friction on landing pages, checkout flows, and long-form sales pages. The goal is not pretty charts; it is finding fixable problems that lift conversion rate.</p>
...
${d.funnels}`,"conversion-psychology":`<p>Conversion optimization is not only button colors and form field counts. It is how people assess risk, process information, and decide to act under uncertainty. Psychology principles explain why the same traffic converts differently on two pages with identical offers. Understanding those triggers helps you write copy, place proof, and sequence asks so more visitors feel safe saying yes.</p>
...
${d.funnels}`,"landing-page-optimization":`<p>Landing page optimization is a system, not a one-time redesign. Small, sequential improvements compound conversion rate over months while paid costs stay flat. The playbook below is how we approach ongoing CRO after baseline message match and tracking are solid.</p>
...
${d.funnels}`,"lifecycle-marketing":`<p>Lifecycle marketing maps messages to where customers actually are: first touch, first value, repeat use, expansion, and risk of churn. Batch-and-blast email ignores those stages and wonders why engagement fades. Aligning email (and adjacent channels) to lifecycle stages turns your list into a coordinated system that supports revenue at each transition.</p>
...
${d.email}`,"automated-nurture-sequences":`<p>Nurture sequences guide subscribers from awareness to action with escalating value and clear calls to action. Done well, they build trust on a schedule. Done poorly, they spam the same pitch six times and train people to ignore you. The architecture matters as much as the copy.</p>
...
${d.analytics}`,"marketing-dashboards":`<p>Dashboards should answer whether marketing is generating profitable revenue, not drown teams in vanity metrics. A useful marketing dashboard connects channel activity to pipeline, cost, and outcomes executives already care about. Everything else is drill-down material.</p>
...
${d.analytics}`},f={seo:`<p><a href="/services/seo">Conoce nuestros servicios de SEO →</a></p>`,localSeo:`<p><a href="/services/local-seo">Conoce nuestros servicios de SEO Local →</a></p>`,googleAds:`<p><a href="/services/google-ads">Conoce nuestros servicios de Google Ads →</a></p>`,ppc:`<p><a href="/services/ppc-management">Conoce nuestros servicios de PPC →</a></p>`,funnels:`<p><a href="/services/funnels">Conoce nuestros servicios de Funnels & CRO →</a></p>`,analytics:`<p><a href="/services/analytics">Conoce nuestros servicios de Anal\xedtica de Marketing →</a></p>`,email:`<p><a href="/services/email-marketing">Conoce nuestros servicios de Email Marketing →</a></p>`},g={"technical-seo-guide":`<p>Google no puede posicionar lo que no puede rastrear, renderizar e indexar correctamente. El SEO t\xe9cnico es la capa de infraestructura que hace que cada inversi\xf3n en contenido y cada esfuerzo de link building cuente de verdad. En KINEXIS Digital empezamos la mayor\xeda de proyectos con una l\xednea base t\xe9cnica porque corregir problemas de indexaci\xf3n y velocidad suele mover rankings antes de que se publique una sola entrada nueva.</p>
...
${f.seo}`,"link-building-strategies":`<p>El link building en 2026 premia sitios que ganan citas porque son genuinamente \xfatiles, no porque enviaron m\xe1s emails de outreach. Los sistemas antispam de Google detectan mejor patrones manipulativos, y los compradores conf\xedan en marcas referenciadas por publicaciones que ya leen. Las estrategias que siguen funcionando se centran en valor original, relaciones y activos que merecen un enlace.</p>
...
${f.funnels}`,"landing-page-optimization":`<p>La optimizaci\xf3n de landing pages es un sistema, no un redise\xf1o de una sola vez. Mejoras peque\xf1as y secuenciales acumulan tasa de conversi\xf3n durante meses mientras los costes de pago se mantienen. El playbook de abajo es c\xf3mo abordamos CRO continuo tras message match base y seguimiento s\xf3lidos.</p>
...
${f.funnels}`,"lifecycle-marketing":`<p>El marketing de ciclo de vida mapea mensajes a d\xf3nde est\xe1n realmente los clientes: primer contacto, primer valor, uso repetido, expansi\xf3n y riesgo de churn. El email masivo ignora esas etapas y se pregunta por qu\xe9 el engagement decae. Alinear email (y canales adyacentes) a etapas del ciclo de vida convierte tu lista en un sistema coordinado que apoya ingresos en cada transici\xf3n.</p>
...
${f.email}`,"automated-nurture-sequences":`<p>Las secuencias de nurture gu\xedan suscriptores de awareness a acci\xf3n con valor creciente y llamadas a la acci\xf3n claras. Bien hechas, construyen confianza con calendario. Mal hechas, spamean el mismo pitch seis veces y entrenan a la gente a ignorarte. La arquitectura importa tanto como el copy.</p>
...
<p>Si quieres ayuda para construir un sistema de nurture que convierta tu lista de email en un motor de llamadas agendadas, es trabajo que hacemos cada semana en KINEXIS Digital.</p>`}}};function e(a,b){return d[b]?.[a]??d.en[a]}}};