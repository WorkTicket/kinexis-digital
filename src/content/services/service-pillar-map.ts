...
export const seoPillarContent: ServicePillarContent = {
  ...
  pricing: {
    ...
    tiers: [
      { name: "Starter", range: "$2,500/mo", description: "Local or niche SEO for businesses with moderate competition and 1–3 target service areas." },
      { name: "Growth", range: "$5,000/mo", description: "Multi-location or mid-competition SEO with content production and active link building." },
      { name: "Scale", range: "$8,000+/mo", description: "Enterprise SEO for competitive markets with high-volume content and authority campaigns." },
    ],
...
export const socialMediaPillarContent: ServicePillarContent = {
  ...
  pricing: {
    ...
    tiers: [
      ...
      { name: "Scale", range: "$5,500+/mo", description: "Full multi-platform management with video production, influencer coordination, and advanced analytics." },
    ],
...
export const videoMarketingPillarContent: ServicePillarContent = {
  ...
  pricing: {
    ...
    tiers: [
      ...
      { name: "Scale", range: "$15,000+", description: "Full video production program with multiple shoot days, ongoing asset creation, and paid distribution." },
    ],
...
export const growthConsultingPillarContent: ServicePillarContent = {
  ...
  pricing: {
    ...
    tiers: [
      ...
      { name: "Scale", range: "$10,000+/mo", description: "Senior strategic partnership for growth-stage companies with multi-channel execution and board reporting." },
    ],
    note: "Consulting engagements are separate from execution services. We can manage implementation or advise your internal team.",
  },
  results: {
    title: "Results we track",
...
export const funnelsPillarContent: ServicePillarContent = {
  ...
  pricing: {
    ...
    note: "One-time funnel builds and ongoing optimization retainers are scoped separately based on traffic and test volume.",
  },
  results: {
    title: "Results we track",
