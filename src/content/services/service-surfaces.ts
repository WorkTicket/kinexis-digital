...
const serviceSurfaceVariants: Record<string, SurfaceVariant[]> = {
  ...
  "local-seo": ["map", "stars", "mobile", "calendar"],
  ...
  cro: ["browser", "funnel", "bars", "stars"],
  "email-marketing": ["email", "flow", "mobile", "chart"],
  ...
  branding: ["palette", "browser", "social", "doc"],
  analytics: ["chart", "bars", "flow", "doc"],
  "growth-consulting": ["bars", "chart", "flow", "doc"],
  funnels: ["funnel", "flow", "browser", "adslot"],
  "landing-pages": ["browser", "mobile", "cursor", "bars"],
  "website-maintenance": ["shield", "gauge", "browser", "doc"],
  "website-speed": ["gauge", "mobile", "chart", "shield"],
  "marketing-audits": ["doc", "bars", "chart", "flow"],
  "marketing-automation-crm": ["flow", "email", "funnel", "chart"],
  "fractional-cmo": ["doc", "chart", "flow", "bars"],
  "training-workshops": ["doc", "browser", "chart", "flow"],
};
...
const serviceSurfacesLocaleContent: Record<string, Record<Locale, ServiceContentLocale>> = {
  ...
  "email-marketing": {
    en: {
      ...
      surfaces: [
        ...
        { name: "Performance", description: "Opens and clicks tied to revenue" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { name: "Rendimiento", description: "Aperturas y clics ligados a ingresos" },
      ],
    },
  },
  "content-marketing": {
  ...
  branding: {
    en: {
      ...
      surfaces: [
        ...
        { name: "Brand Guidelines", description: "Rules your team can actually follow" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { name: "Guía de Marca", description: "Reglas que tu equipo sí puede seguir" },
      ],
    },
  },
  analytics: {
  ...
  "marketing-audits": {
    en: {
      title: "What a real audit delivers",
      subtitle:
        "Not a 40-page PDF. Validated tracking, channel cost per qualified lead, funnel leaks, and a severity-ranked fix list your team can run Monday morning.",
      surfaces: [
        { name: "Tracking Validation", description: "GA4, pixels, calls, CRM" },
        { name: "Findings Brief", description: "Evidence, severity, impact" },
        { name: "Channel Review", description: "Judged on cost per lead" },
        { name: "Action Roadmap", description: "P0–P2 fixes with owners" },
      ],
    },
    es: {
      title: "Lo que entrega una auditoría real",
      subtitle:
        "No un PDF de 40 páginas. Tracking validado, costo por lead calificado, fugas del embudo y una lista de arreglos por severidad que tu equipo puede ejecutar el lunes.",
      surfaces: [
        { name: "Validación de Tracking", description: "GA4, pixels, llamadas, CRM" },
        { name: "Brief de Hallazgos", description: "Evidencia, severidad, impacto" },
        { name: "Revisión de Canales", description: "Juzgados por costo por lead" },
        { name: "Roadmap de Acción", description: "Arreglos P0–P2 con responsables" },
      ],
    },
  },
  "marketing-automation-crm": {
    en: {
      ...
      surfaces: [
        ...
        { name: "Reporting", description: "Pipeline health at a glance" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { name: "Reportes", description: "Salud del pipeline de un vistazo" },
      ],
    },
  },
  "fractional-cmo": {
