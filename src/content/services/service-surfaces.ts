  ...
  "microsoft-ads": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "flow", name: "Conversion Tracking", description: "Leads attributed to this channel" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "flow", name: "Seguimiento de Conversiones", description: "Leads atribuidos a este canal" },
      ],
    },
  },
  ...
  "social-media": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "chart", name: "Engagement", description: "Comments, shares, and saves that compound" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "chart", name: "Engagement", description: "Comentarios, shares y saves que se acumulan" },
      ],
    },
  },
  ...
  analytics: {
    en: {
      ...
      surfaces: [
        ...
        { variant: "doc", name: "Reports", description: "Clear summaries leadership can act on" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "doc", name: "Reportes", description: "Resúmenes claros para tomar decisiones" },
      ],
    },
  },
  ...
  "growth-consulting": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "doc", name: "Prioritized Plan", description: "What to do next, in order" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "doc", name: "Plan Priorizado", description: "Qué hacer después, en orden" },
      ],
    },
  },
  ...
  "landing-pages": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "bars", name: "A/B Tests", description: "Headline and CTA winners shipped" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "bars", name: "Pruebas A/B", description: "Ganadores de titular y CTA lanzados" },
      ],
    },
  },
  ...
  "website-maintenance": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "gauge", name: "Backups", description: "Restorable points if something breaks" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "gauge", name: "Backups", description: "Puntos de restauración si algo falla" },
      ],
    },
  },
  ...
  "website-speed": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "shield", name: "Caching & CDN", description: "Delivery tuned for real visitors" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "shield", name: "Caché y CDN", description: "Entrega afinada para visitantes reales" },
      ],
    },
  },
  ...
  "marketing-audits": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "flow", name: "Action Plan", description: "What to fix first, with owners" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "flow", name: "Plan de Acción", description: "Qué arreglar primero, con responsables" },
      ],
    },
  },
  ...
  "training-workshops": {
    en: {
      ...
      surfaces: [
        ...
        { variant: "doc", name: "Playbooks", description: "Take-home docs your team keeps using" },
      ],
    },
    es: {
      ...
      surfaces: [
        ...
        { variant: "doc", name: "Playbooks", description: "Documentos que tu equipo sigue usando" },
      ],
    },
  },
};
