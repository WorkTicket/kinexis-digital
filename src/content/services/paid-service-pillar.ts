...
export const ppcPillarContent: ServicePillarContent = {
  overview: {
    title: "PPC and Google Ads management built for revenue, not impressions.",
    paragraphs: [
      "Google Ads captures buyers at the moment of intent. Done right, it is the highest-ROI paid channel for most businesses. Done wrong, or run in silos alongside Meta and LinkedIn, it becomes a budget drain nobody can diagnose.",
      "KINEXIS manages Google Search, Shopping, Performance Max, Display, and YouTube with a singular focus on ROAS and qualified conversions. When you run multiple platforms, we coordinate budgets, tracking, and reporting as one revenue program.",
      "Every campaign connects to conversion tracking that proves revenue impact. We integrate Google Ads data with GA4, CRM, and call tracking for full-funnel visibility across every channel you pay for.",
    ],
  },
  deliverables: {
    title: "What's included",
    subtitle: "Google Search, Shopping, and PMax management plus cross-channel coordination when you need it.",
    items: [
      ...
      { title: "Cross-Channel Budget Coordination", description: "Unified reporting and weekly budget shifts across Google, Meta, LinkedIn, and Microsoft when you run multiple platforms." },
    ],
  },
  timeline: {
  ...
  pricing: {
    ...
    subtitle: "What you get when Google Ads expertise and cross-channel discipline live in one dedicated team.",
    tiers: [
      { name: "Starter", range: "$500/mo or 15%", description: "Single-channel management for local businesses with up to $5K ad spend." },
      { name: "Growth", range: "$1,000/mo or 12%", description: "Multi-channel PPC for growing brands with $5K–$25K monthly ad spend." },
      { name: "Scale", range: "Custom (10–15%)", description: "Enterprise PPC with advanced attribution, multi-location, and $25K+ ad spend." },
    ],
    note: "Management fees are billed as a flat monthly rate or a percentage of ad spend, separate from the spend itself. We provide a detailed proposal after your strategy call.",
  },
  results: {
...
export const metaAdsPillarContent: ServicePillarContent = {
  ...
  pricing: {
    title: "Managed Meta Ads vs. boosting posts",
    subtitle: "What changes when creative, audiences, and tracking are run as one program.",
    tiers: [
      { name: "Starter", range: "$500/mo", description: "Single Meta account with prospecting and retargeting, up to $5K ad spend." },
      { name: "Growth", range: "$1,000/mo", description: "Creative testing program and catalog ads for accounts up to $15K ad spend." },
      { name: "Scale", range: "$2,000+/mo", description: "Multi-account programs with a UGC creative pipeline and $15K+ ad spend." },
    ],
...
export function getPaidServiceFaqs(variant: PaidServiceVariant, _locale: Locale): FAQItem[] {
  ...
  const metaExtras: FAQItem[] = [
    { question: "How much should I spend on Meta Ads?", answer: "We recommend $3,000 to $15,000 per month in ad spend for most B2B and e-commerce accounts. Management fees start at $500 per month on top of ad spend." },
  ...
  const ppcExtras: FAQItem[] = [
    { question: "Do you manage Performance Max campaigns?", answer: "Yes. We build and optimize PMax with proper asset groups, audience signals, and feed data. We also monitor search term insights to prevent PMax from cannibalizing branded Search traffic." },
    { question: "Will I own my Google Ads account?", answer: "Always. We work inside your account with full admin access. If you leave, you keep every campaign, keyword list, and conversion setup we built." },
    { question: "What platforms do you manage?", answer: "Google Ads is our core: Search, Shopping, Performance Max, Display, and YouTube. We also manage Meta, LinkedIn, and Microsoft Ads when you need cross-channel coordination under one team." },
  ];
