...
export const localSeoContent: Record<Locale, LocalSeoContent> = {
  en: {
    ...
    results: [
      ...
      { metric: "Top 3", label: "local pack · 34 of 60 keywords" },
    ],
  ...
  es: {
    ...
    results: [
      { metric: "136%", label: "llamadas de emergencia · Plumbing Co., 8 meses" },
      { metric: "+376%", label: "interacciones GBP · mismo cliente" },
      { metric: "Top 3", label: "pack local · 34 de 60 keywords" },
    ],
