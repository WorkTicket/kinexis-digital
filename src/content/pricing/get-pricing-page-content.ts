...
> = {
  ...
  "meta-ads": { caseStudy: "saas", result: "2.4X monthly orders", tierName: "Growth" },
  ...
  analytics: { caseStudy: "saas", result: "2.4X monthly orders", tierName: "Growth" },
  "growth-consulting": { caseStudy: "saas", result: "2.4X monthly orders", tierName: "Growth" },
