...
const L = {
  ...
  googleAds: `<p><a href="/services/google-ads">Conoce nuestros servicios de Google Ads →</a></p>`,
  ppc: `<p><a href="/services/ppc-management">Conoce nuestros servicios de PPC →</a></p>`,
