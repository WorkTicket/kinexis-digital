...
export const agencyHubContent: Record<Locale, AgencyHubContent> = {
  en: {
    ...
    proof: {
      ...
      metrics: [
        ...
        { value: "+340%", label: "new patients · Dental Practice, 6 mo" },
        { value: "4X", label: "monthly revenue · E-Commerce client, 9 mo" },
  ...
  es: {
    ...
    proof: {
      ...
      metrics: [
        { value: "+340%", label: "tráfico orgánico · Landscaping Co., 8 meses" },
        { value: "+340%", label: "pacientes nuevos · Clínica Dental, 6 meses" },
        { value: "4X", label: "ingresos mensuales · E-Commerce, 9 meses" },
