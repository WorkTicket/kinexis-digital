...
export const caseStudySlugMeta: Record<string, CaseStudySlugMeta> = {
  ...
  "saas-platform-growth": {
    ...
    faq: [
      ...
      { q: "How did you reduce CAC by 43%?", a: "As organic traffic grew from 950 to 2,280 visits per month, paid channels were scaled back. The content engine contributed 62% of new demo requests by month 8, significantly lowering the blended cost per acquisition." },
