...
const enServices: ServiceCardContent[] = [
  { id: "seo", label: "SEO", description: "Technical foundations, authority content, and link building that keeps paying off over time.", stat: "+181% traffic · Landscaping Co." },
  { id: "localSeo", label: "Local SEO", description: "Geo-targeted rankings, Google Business Profile optimization, and map pack placements for businesses that compete locally.", stat: "136% more calls · Plumbing Co." },
  { id: "ppcManagement", label: "Google Ads (PPC)", description: "Google Search, Shopping, and Performance Max management plus cross-channel coordination on Meta, LinkedIn, and Microsoft.", stat: "136% more calls · Plumbing Co." },
  ...
  { id: "webDesign", label: "Web Design", description: "Custom, conversion-optimized sites built to turn visitors into qualified leads.", stat: "1.8% → 3.9% conv. · Landscaping Co." },
  ...
  { id: "cro", label: "Conversion Rate Optimization", description: "Heatmaps, testing, and UX fixes on high-traffic pages that should be converting better than they do.", stat: "1.8% → 3.9% conv. · Landscaping Co." },
  ...
  { id: "content", label: "Content Marketing", description: "Authority-building content that answers what your buyers are searching for.", stat: "2.4X orders · Manos Creativas" },
  ...
  { id: "consulting", label: "Digital Marketing Strategy", description: "A documented plan tied to your unit economics, ready for your team or ours to execute.", stat: "2.4X orders · Manos Creativas" },
  ...
  { id: "funnels", label: "Customer Journey & Funnels", description: "Journey mapping, lead capture, and nurture on the path where revenue is won or lost.", stat: "2.4X orders · Manos Creativas" },
...
const enPathways: PathwayContent[] = [
  {
    ...
    results: ["2.8X leads · Landscaping Co.", "28 local pack keywords · 10 mo", "1.8% → 3.9% conv. · same client"],
  ...
  },
  {
    ...
    results: ["1.8% → 3.9% conv. · Landscaping rebuild", "2.8X qualified leads · 10 mo", "Lighthouse 94 · performance score"],
  ...
  },
  {
    ...
    results: ["136% emergency calls · Plumbing Co.", "40% ad spend cut · same client", "34 of 60 keywords top-3 · local pack"],
...
const enIndustries: IndustrySolutionContent[] = [
  {
    ...
    outcomes: ["2.4X monthly orders · 8 mo", "organic share up · paid dependency down", "€17.2K revenue · marketing-attributed"],
  },
  {
    id: "agencies",
    label: "Agencies & B2B",
  ...
  },
  {
    ...
    outcomes: ["52 emergency calls/mo · Plumbing Co.", "136% call growth · 8 mo", "Top 3 local pack · 34 keywords"],
  },
];
...
export const servicesPageContent: Record<Locale, ServicesPageContent> = {
  ...
  es: {
    ...
    capabilities: {
      ...
      services: [
        { id: "seo", label: "SEO", description: "Fundamentos técnicos, contenido de autoridad y construcción de enlaces que siguen dando resultados con el tiempo.", stat: "+181% tráfico · Landscaping Co." },
        { id: "localSeo", label: "SEO Local", description: "Rankings geolocalizados, optimización del Perfil de Google Business y posiciones en el mapa para negocios que compiten localmente.", stat: "136% más llamadas · Plumbing Co." },
        { id: "ppcManagement", label: "Google Ads (PPC)", description: "Gestión de Google Search, Shopping y Performance Max más coordinación multicanal en Meta, LinkedIn y Microsoft.", stat: "136% más llamadas · Plumbing Co." },
        ...
        { id: "webDesign", label: "Diseño Web", description: "Sitios personalizados y optimizados para conversión que convierten visitantes en leads calificados.", stat: "1.8% → 3.9% conv. · Landscaping Co." },
        ...
        { id: "cro", label: "Optimización de Conversión", description: "Heatmaps, testing y arreglos de UX en páginas de alto tráfico que deberían convertir mejor.", stat: "1.8% → 3.9% conv. · Landscaping Co." },
        ...
        { id: "content", label: "Marketing de Contenidos", description: "Contenido que construye autoridad y responde lo que tus compradores buscan.", stat: "2.4X pedidos · Manos Creativas" },
        ...
        { id: "consulting", label: "Estrategia de Marketing Digital", description: "Un plan documentado ligado a tu unit economics, listo para que lo ejecute tu equipo o el nuestro.", stat: "2.4X pedidos · Manos Creativas" },
        ...
        { id: "funnels", label: "Customer Journey y Embudos", description: "Mapeo del recorrido, captura de leads y nurture en la ruta donde se gana o pierde el ingreso.", stat: "2.4X pedidos · Manos Creativas" },
      ...
      items: [
        {
          ...
          results: ["2.8X leads · Landscaping Co.", "28 keywords en pack local · 10 meses", "1.8% → 3.9% conv. · mismo cliente"],
        ...
        },
        {
          ...
          results: ["1.8% → 3.9% conv. · rebuild Landscaping", "2.8X leads calificados · 10 meses", "Lighthouse 94 · puntuación de rendimiento"],
        ...
        },
        {
          ...
          results: ["136% llamadas de emergencia · Plumbing Co.", "40% reducción de gasto · mismo cliente", "34 de 60 keywords top-3 · pack local"],
