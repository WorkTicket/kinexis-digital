...
const enServices: ServiceCardContent[] = [
  ...
  { id: "content", label: "Content Marketing", description: "Authority-building content that answers what your buyers are searching for.", stat: "2.4X demos · SaaS Platform" },
  ...
  { id: "consulting", label: "Digital Marketing Strategy", description: "A documented plan tied to your unit economics, ready for your team or ours to execute.", stat: "2.4X demos · SaaS Platform" },
  ...
  { id: "funnels", label: "Customer Journey & Funnels", description: "Journey mapping, lead capture, and nurture on the path where revenue is won or lost.", stat: "2.4X demos · SaaS Platform" },
...
const enIndustries: IndustrySolutionContent[] = [
  {
    ...
    outcomes: ["2.4X demo requests · 8 mo", "43% CAC reduction · organic channels", "$17.2K MRR · marketing-attributed"],
  },
  {
    id: "agencies",
    label: "Agencies & B2B",
  ...
  es: {
    ...
    capabilities: {
      ...
      services: [
        ...
        { id: "content", label: "Marketing de Contenidos", description: "Contenido que construye autoridad y responde lo que tus compradores buscan.", stat: "2.4X demos · Plataforma SaaS" },
        ...
        { id: "consulting", label: "Estrategia de Marketing Digital", description: "Un plan documentado ligado a tu unit economics, listo para que lo ejecute tu equipo o el nuestro.", stat: "2.4X demos · Plataforma SaaS" },
        ...
        { id: "funnels", label: "Customer Journey y Embudos", description: "Mapeo del recorrido, captura de leads y nurture en la ruta donde se gana o pierde el ingreso.", stat: "2.4X demos · Plataforma SaaS" },
